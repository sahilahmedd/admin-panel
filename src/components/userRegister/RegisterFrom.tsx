...
//         genderError = "Father must be Male";
//       } else if (fieldType === "mother" && userData.PR_GENDER !== "F") {
//         genderError = "Mother must be Female";
//       } else if (fieldType === "spouse") {
//         // For spouse, check opposite gender (assuming heterosexual relationships)
//         // You can modify this logic based on your requirements
//         if (formData.PR_GENDER === "M" && userData.PR_GENDER !== "F") {
//           genderError = "Spouse gender should be Female";
//         } else if (formData.PR_GENDER === "F" && userData.PR_GENDER !== "M") {
//           genderError = "Spouse gender should be Male";
//         }
//       }

//       // Update gender errors
//       setGenderErrors((prev) => ({ ...prev, [fieldType]: genderError }));

//       // If there's a gender error, don't proceed with setting the data
//       if (genderError) {
//         // Clear the names if gender is wrong
//         if (fieldType === "father") {
//           setFatherName("");
//           setFormData((prev) => ({ ...prev, PR_FATHER_NAME: "" }));
//         }
...
//       // If gender is correct, set the name for display AND in form data
//       if (fieldType === "father") {
...
//     if (genderErrors.father || genderErrors.mother || genderErrors.spouse) {
...
//         if (spouseUniqueId === fatherUniqueId) {
//           errors.PR_SPOUSE_ID = "Spouse ID cannot be same as Father ID";
//         }
//         if (spouseUniqueId === motherUniqueId) {
//           errors.PR_SPOUSE_ID = "Spouse ID cannot be same as Mother ID";
//         }
//       } else {
...
//                 onChange={(e) => {
//                   // Update both the display name and form data
